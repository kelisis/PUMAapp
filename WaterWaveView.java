...
public class WaterWaveView extends View {
    ...
    private int mWaveColor = Color.parseColor("#00a03e");
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    flowNum = String.valueOf((int)count) + '%';
                }
            } catch (Exception e) {
    ...
    public void setWater(float fac){
        this.flowNum = String.valueOf((int)fac) + '%';
        this.mWaterLevel = fac/100;
    }
   /* public void setmWaterLevel(float mWaterLevel) {
        this.mWaterLevel = mWaterLevel;
    }
	public void setmWaterText(String mWaterText) {this.flowNum = mWaterText + '%';}*/
